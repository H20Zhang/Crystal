 ...
 * </h1>
 * <ul>
 * 	<li>Pattern name: Twin Triangle </li>
 * 	<li>Pattern: (0,1),(0,5),(1,2),(1,3),(1,4),(2,3)  </li>
 * 	<li>Core: (0,1,3)</li>
...
public class TwinTriangle extends Configured implements Tool {
    ...
    public static class TwinTriangleMapper
    ...
    public static class TwinTriangleReducer
	...
	protected void reduce(OneNodeKey key, Iterable<OneNodeKeyIntDegreeArray> values, Context context)
		...
		for (int j = i + 1; j < tempList.size(); ++j) {
		    ...
		    context.getCounter("test", "triangle").increment(left * right - counter_intersection);
		}
	    }
    ...
    public static class TwinTriangleOReducer
	...
	if (isOutput == false) {
	    ...
	    job.setMapperClass(TwinTriangleMapper.class);
	    job.setReducerClass(TwinTriangleOReducer.class);
	...
	log.info("[TwinTriangleC] Time elapsed: " + (endTime - startTime) / 1000 + "s");
    }
