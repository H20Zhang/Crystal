...
public class Square extends Configured implements Tool {
	...
	public static void main(String[] args) throws Exception {
		...
		for (int i = 0; i < p; i++) {
			...
			ToolRunner.run(conf, new Square(), args);
		}
    ...
    public static class SquareMapper extends Mapper<OneNodeKey, IntDegreeArray, NullWritable, NullWritable> {
...
//		context.getCounter("test","enumeration").increment(1);
		...
		@Override
	protected void map(OneNodeKey key, IntDegreeArray value,
		Mapper<OneNodeKey, IntDegreeArray, NullWritable, NullWritable>.Context context)
